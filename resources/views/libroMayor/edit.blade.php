...
@section('page-header')
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title">Editar Libro Mayor</h4>
							</div>
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Editar Libro Mayor</div>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('libroMayor.update', ['libroMayor' => $libro->id]) }}" role="form">
                                            @csrf
                                            @method('PUT')
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="cuenta" id="cuenta" class="form-control input-sm" placeholder="ingrese Nombre de la cuenta" value="{{ $libro->cuenta }}">
                                            </div>
