							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Crear una Factura</div>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('factura.storeNew') }}"  role="form">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <a href="{{ route('factura.index') }}" class="btn btn-lg btn-danger">Cancelar</a>
                                            </div>
                                        </form>
                                    </div>
								</div>
...
<script>
    ...
    function ActualizarTasa(){
        ...
        if(divisasIds == 'Bs' ){
            ...
            $('#suma-precio').text(`SubTotal: ${TotalDivisaS.toFixed(2)  } ${tasaSelect.name} y en Bs ${precioTotal.toFixed(2) * tasa[2].tasa} `  );
            $('#inputSumaPrecio').val(TotalDivisaS.toFixed(2));
