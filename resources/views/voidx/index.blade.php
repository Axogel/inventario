                                                    ...
                                                    @if($voids->isNotEmpty())
                                                        @foreach($voids as $void)
                                                            <tr class="bold">
                                                                ...
                                                                <td>{{$void->amount}}</td>
                                                                <td><a class="btn btn-primary btn-xs" href="{{ route('voidx.edit', ['id' => $void->id]) }}" ><span class="fa fa-pencil"></span></a></td>
                                                                <td>
                                                                    <form action="{{ route('voidx.destroy', ['id' => $void->id]) }}" method="delete">
                                                                        {{csrf_field()}}
