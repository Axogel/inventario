							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card">
                                    <div class="card-header">
										<div class="card-title">Create Site</div>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('site.store') }}"  role="form">
                                            {{ csrf_field() }}
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="license_key" id="license_key" class="form-control input-sm" placeholder="License Key">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="text" name="Store_name" id="Store_name" class="form-control input-sm" placeholder="Store Name">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-addon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></span>
                                                <input type="text" name="Store_address" id="Store_address" class="form-control input-sm" placeholder="Store Address">
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                <div class="col-1"><label class="form-label">Region</label></div>
                                                <div class="col-11"><select name="region" class="form-control custom-select select2">
