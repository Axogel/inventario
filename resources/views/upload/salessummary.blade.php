												...
												<table id="example" class="table table-bordered text-nowrap key-buttons">
													<thead>
														<tr>
                                                    		...
                                                    		<th class="border-bottom-0">NETSALES</th>
                                                    		<th class="border-bottom-0">COMPS</th>
                                                    		<th class="border-bottom-0">PROMOS</th>
                                                    		<th class="border-bottom-0">VOIDS</th>
                                                    		<th class="border-bottom-0">TAXES</th>
                                                    		<th class="border-bottom-0">GRSSALES</th>
