												...
												<table id="example" class="table table-bordered text-nowrap key-buttons">
													<thead>
														<tr>
													        ...
													        <th class="border-bottom-0">ITEMID</th>
                                                            <th class="border-bottom-0">NAME</th>
                                                            <th class="border-bottom-0">QTYSOLD</th>
                                                            <th class="border-bottom-0">ITEMPRICE</th>
                                                            <th class="border-bottom-0">TOTALPRICE</th>
                                                            <th class="border-bottom-0">TAX</th>
                                                            <th class="border-bottom-0">COSTPRICE</th>
